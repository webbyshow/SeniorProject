...
# เริ่มต้นการใช้งาน
    ...
    try:
        if realtime == 0: loop = iter(lambda: pipeline.wait_for_frames(), None)
        ...
        # This loop below is where we start the command
        ...
        for frames in loop:
            ...
            if depth_image is None or color_image is None: continue
